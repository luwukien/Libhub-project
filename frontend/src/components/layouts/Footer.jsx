        ...
        <footer id="footer" className="w-95 xl:w-[70%] mx-auto pb-24 text-gray-500 text-base p-7" >
          <div className="flex flex-col md:flex-row text-center md:text-left gap-8">
            <div className="basis-1/3 ">
              <div className="flex flex-col items-center">
                <img src="/anhchot.png" className="w-44 h-auto mb-1" />
              </div>
              <div className="">
            ...
            <div className="basis-1/3 mt-7">
              ...
              <div className="ct-link text-lg font-medium"><a href="mailto:jsclub.fpt@gmail.com">jsclub.fpt@gmail.com</a></div>
              <div className="ct-link text-lg font-medium mt-5"><a href="#">(+84) 12 3456 789</a></div>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex justify-end">
              <a href="#" className="text-gray-500 hover:text-pornhub-300">
                <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                  <path fillRule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clipRule="evenodd" />
                </svg>
                <span className="sr-only">Facebook page</span>
              </a>
              <a href="#" className="text-gray-500 hover:text-pornhub-300 ms-5">
